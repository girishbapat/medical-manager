$(document).ready(function(){
	$.ajax({
		url: contextPath+"doctor/json/practicePlace/logged",
		method: "GET",
...
function buildNotificationNewSession(patient){
	...
	$(".notifications .dropdown-menu .recentAdded a").attr('href','/consultpal-manager/medical-session/doctor/list?patienName='+patient.name+" "+patient.lastname);
